...
function Index() {
  return (
    <div>
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-4 pt-12 pb-20 md:grid-cols-2 md:items-center md:pt-20 md:pb-28">
          ...
          <div className="relative">
            <span className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-background/70 px-3 py-1 text-xs font-medium text-muted-foreground backdrop-blur">
              <Sparkles className="h-3.5 w-3.5 text-accent" /> Trusted local team · Free quotes ·
              24/7
            </span>
            ...
            <p className="mt-5 text-lg text-muted-foreground">
              From a leaky tap at midnight to a full house repaint — one local team of plumbers,
              painters, electricians, gardeners and more. Fair prices, and we actually turn up.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {[
                ...
                return (
                  <div
                    key={s.l}
                    className="rounded-2xl border border-border/60 bg-card/95 px-4 py-3 shadow-md"
          ...
          <div className="relative">
            ...
            <div className="pointer-events-none absolute inset-0 -z-10 mx-auto h-full w-full">
              <div className="absolute inset-0 rounded-full conic-glow opacity-20 blur-2xl" />
            </div>
            <img
              src={heroHouse}
        ...
        <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-muted-foreground">
              Ten core services covering most jobs around the house — and if it's not listed, just
              ask.
            </p>
          </div>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              If it's a job around the home, chances are we can do it. Just ask.
            </p>
      ...
      {/* How it works */}
      <section className="content-auto bg-secondary/40 py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl">How it works</h2>
          <p className="mt-2 text-muted-foreground">
            Free quotes. No call-out fee. Fixed prices on most jobs.
          </p>
      ...
      <section className="content-auto bg-secondary/40 py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-muted-foreground">
              No call-out fees. No surprises. Pay for the job, not the jargon.
            </p>
          </div>
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {[
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <Accordion type="single" collapsible className="mt-8 w-full">
            <AccordionItem value="services">
              ...
              <AccordionContent>
                Ten core services: gardening, painting, cleaning, plumbing, electrical, handyman
                jobs, carpet removal, carpet fitting, house removals and man with van. If your job
                isn't on the list, ask anyway — most home tasks fall under one of our trades.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="hours">
              <AccordionTrigger>Are you really available 24/7?</AccordionTrigger>
              <AccordionContent>
                Yes. Routine bookings run 8am–8pm every day, and we take emergency callouts (leaks,
                blockages, lock-outs, urgent removals) round the clock. Nights and Sundays carry a
                small out-of-hours rate.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="turnaround">
              <AccordionTrigger>How quickly can you get the job done?</AccordionTrigger>
              <AccordionContent>
                Most quotes go back the same day. Small jobs (handyman, plumbing fixes, man with
                van) usually fit in the same week — often within 48 hours. Larger work like full
                house removals, repaints or carpet fits is typically booked 1–2 weeks ahead.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="area">
              <AccordionTrigger>What area do you cover?</AccordionTrigger>
              <AccordionContent>
                The local town and surrounding villages within roughly a 100-mile radius. Removals
                and man-with-van jobs go further afield — just send pickup and drop-off postcodes
                and we'll quote for travel.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="pricing">
              <AccordionTrigger>How does pricing work?</AccordionTrigger>
              <AccordionContent>
                Free quotes, no call-out fees. Quick fix jobs are £39/hour (1-hour minimum). Half
                day is £149 for up to four hours of stacked jobs. Larger work is quoted as a
                fixed-price project after a free survey. Materials at cost; waste removal included
                on half-day and project work.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="insured">
              <AccordionTrigger>Are you insured and vetted?</AccordionTrigger>
              <AccordionContent>
                Yes — fully insured with public liability cover on every job. Our tradespeople are
                local, vetted, and the same person you book is the one who turns up.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="payment">
              <AccordionTrigger>How do I pay?</AccordionTrigger>
              <AccordionContent>
                Bank transfer or card, on completion. We send a clear invoice with a breakdown of
                labour, materials and any extras agreed on the day. No deposit needed for most jobs
                — projects over £500 take a small booking deposit.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="quote-info">
              ...
              <AccordionContent>
                ...
                <ul className="mt-3 list-disc space-y-1.5 pl-5">
                  ...
                  <li>
                    Rough size or scope (e.g. "two bedrooms", "small front lawn", "3-bed
                    end-of-tenancy")
                  </li>
      ...
      {/* CTA — multi-blob */}
      <section className="content-auto mx-auto max-w-6xl px-4 py-14 md:py-20">
        <div className="relative overflow-hidden rounded-3xl bg-primary px-8 py-14 text-primary-foreground shadow-2xl md:px-14 md:py-20">
          {/* Animated blobs */}
          <div className="pointer-events-none absolute -left-16 -top-16 h-72 w-72 bg-secondary opacity-30 blur-2xl" />
          <div className="pointer-events-none absolute -right-20 top-10 h-80 w-80 bg-accent opacity-30 blur-2xl" />
          <div className="pointer-events-none absolute -bottom-24 left-1/3 h-72 w-72 bg-secondary opacity-20 blur-2xl" />
          ...
          <div className="relative flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            <div>
              ...
              <h2 className="mt-7 text-3xl font-extrabold tracking-tight md:text-5xl">
                One number. <span className="text-trade-gradient">Every job.</span>
              </h2>
              <p className="mt-3 max-w-xl text-primary-foreground/85">
                Tell us what's broken, blocked, overgrown or half-finished — we'll quote it free,
                24/7.
              </p>
            </div>
            <Link
