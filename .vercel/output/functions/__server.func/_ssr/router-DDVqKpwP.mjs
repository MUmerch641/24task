...
import { m as Phone, X, i as Menu, M as Mail } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-qk5Uh8hq.css";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("g", { transform: "translate(20 24) rotate(-30 12 12)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-6xl items-center justify-between px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "group flex items-center gap-3 font-semibold tracking-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-1 rounded-xl bg-trade-gradient opacity-70 blur-md transition-opacity group-hover:opacity-100" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex h-11 w-11 items-center justify-center rounded-xl bg-primary text-secondary glow-yellow", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LogoMark, { className: "h-7 w-7" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 -right-1 rounded-md bg-secondary px-1 py-px text-[8px] font-extrabold leading-none text-secondary-foreground shadow", children: "24/7" })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-primary text-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogoMark, { className: "h-6 w-6" }) }),
...
const $$splitComponentImporter$2 = () => import("./contact-vLrj0E6E.mjs");
...
const $$splitComponentImporter = () => import("./index-Bb8mUCR3.mjs");
