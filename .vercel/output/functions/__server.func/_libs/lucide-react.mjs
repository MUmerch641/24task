...
const Droplet = createLucideIcon("droplet", __iconNode$m);
const __iconNode$l = [
...
const Hammer = createLucideIcon("hammer", __iconNode$k);
const __iconNode$j = [
...
const Hourglass = createLucideIcon("hourglass", __iconNode$j);
const __iconNode$i = [
...
const MessageSquareQuote = createLucideIcon("message-square-quote", __iconNode$d);
const __iconNode$c = [
  [
    "path",
    {
...
const PaintRoller = createLucideIcon("paint-roller", __iconNode$b);
const __iconNode$a = [
  [
    "path",
    {
...
const ThumbsUp = createLucideIcon("thumbs-up", __iconNode$4);
const __iconNode$3 = [
