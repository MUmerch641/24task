...
const Hourglass = createLucideIcon("hourglass", __iconNode$k);
const __iconNode$j = [
...
const MessageSquareQuote = createLucideIcon("message-square-quote", __iconNode$e);
const __iconNode$d = [
  [
    "path",
    {
...
const PaintRoller = createLucideIcon("paint-roller", __iconNode$c);
const __iconNode$b = [
  [
    "path",
    {
